  ...
  return (
    <div className="">
      <div className="max-w-70 mx-auto border border-primary/20 mt-12">
        <div className="flex items-center justify-center py-7 bg-[#0a0a0a] ">
          <div className="relative w-55 h-55 flex items-center justify-center">
            ...
            {/* Floating info box */}
            <div className="absolute -top-4 -right-14 bg-[#111] border border-green-400/20 px-2 py-1 rounded-sm">
              <p className="text-green-400/70 text-[10px] font-mono">TOKEN · ACTIVE</p>
            </div>

            {/* Green token box */}
            <div
              className="relative w-37.5 h-37.5 bg-primary rounded-xl flex items-center justify-center
